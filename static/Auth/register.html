...
<body>
  ...
  <header>
    <nav class="topNavbar">
      ...
      <div class="logo">
        <a href="../index.html">
          <img src="https://www.uhasselt.be/images/DCM/huisstijl/2017/logo/download/UHasselt-liggend.jpg" width="200px"
            alt="">
        </a>
      </div>
      <!--
      ...
      <a class="submenu login" href="../Auth/login.html">Login</a>
      <!-- <a class="submenu register" href="./register.html">Register</a> -->
  ...
  <div class="content">
    ...
    <div class="flexbox">
      ...
      <!-- Side Img
      <div class="sideImg">
        <img src="https://i2.wp.com/blogpascher.com/wp-content/uploads/2015/11/frontend-login-page.jpg" alt="">
      </div> -->
